...
| `plan/v0.5.0-usability.plan.md` | Add doctor diagnostics, E2E acceptance summaries, session inspection, report summaries, and a manual E2E workflow | In Progress |
