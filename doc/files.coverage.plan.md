...
| Metric | Count |
|---|---|
| Total source files (non-test `.go`) | 36 |
| Test files (`*_test.go`) | 10 |
| Project-level docs (`doc/*.md`) | 6 |
| File-level docs (`doc/src/**/*.plan.md`) | 36 |
...
| CLI Command | 7 | `cmd/root.go`, `cmd/version.go`, `cmd/session.go`, `cmd/record.go`, `cmd/replay.go`, `cmd/diff.go`, `cmd/report.go` |
